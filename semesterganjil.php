        ...
        <section class="site-section subpage-site-section section-portfolio">
            <div class="container">
                ...
                <ul class="portfolio-sorting list-inline text-center">
                    ...
                    <li><a href="#" class="btn btn-gray" data-group="kelasvii">Kelas VII</a></li>
                    <li><a href="#" class="btn btn-gray" data-group="kelasviii">Kelas VIII</a></li>
                    <li><a href="#" class="btn btn-gray" data-group="keleasix">Kelas IX</a></li>
