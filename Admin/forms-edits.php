    ...
    <div class="row align-items-top">
              ...
              <?php foreach($query as $a){ ?>
                <div style="padding-top:15px;" class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="mapel" class="form-control" value="<?php echo $a['mapel']?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Deskripsi Mata Pelajaran</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="dess" style="height: 100px"><?php echo $a['dess']?></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Pengampu</label>
                  <div class="col-sm-10">
                    <input type="text" name="namaguru" class="form-control"value="<?php echo $a['namaguru']?>">
                  </div>
                </div>
                <div class="row mb-3">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Foto Pengampu</label>
                <div class="col-sm-10">
                  <input class="form-control" type="file" name="guru">
                  <input type="checkbox" name="delete_guru" value="1"> Delete
                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Foto Cover</label>
                <div class="col-sm-10">
                  <input class="form-control" type="file" name="gambar">
                  <input type="checkbox" name="delete_gambar" value="1"> Delete
                </div>
              </div>
                <?php } ?>         
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="update" name="update" id="update" class="btn btn-primary">Submit Form</button>
                  </div>
                </div>
