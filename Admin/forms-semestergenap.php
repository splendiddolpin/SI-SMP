              ...
              <?php 
                  ...
                  if(isset($_GET['info'])){
                      if($_GET['info']=="deleted"){
                        echo "<div class='alert alert-danger' style='text-align:center;' role='alert'>Delete Mata Pelajaran Berhasil !</div>";
                      }
                    else if ($_GET['info']=="updated") {
                      echo "<div class='alert alert-success' style='text-align:center;' role='alert'>Pembaruan Mata Pelajaran Berhasil !</div>";
                    }
                    else if ($_GET['info']=="added") {
                      $pol1 = "SELECT * FROM semestergenap ORDER BY id DESC LIMIT 1 ";
                      $pol3 = $mysqli->query($pol1);
                      echo "<div class='alert alert-primary' style='text-align:center;' role='alert'>Menambahkan Mata Pelajaran Baru Berhasil !";
                      echo "<br>";
                      echo "<br>";
                      foreach($pol3 as $x){ ?>
                      Judul : <?php echo $x['mapel'] ?></div>
                        <?php } 
                    }
                  }
           ?>
              <!-- General Form Elements -->
              <span style="color: blue;">Bagian Edit pada Mata Pelajaran</span><br><br>  
              ...
              <div class="row align-items-top">
                <?php foreach($isi_edit as $a){ ?>
                <div class="col-lg-4" data-groups='["<?php echo $a['group']?>"]'>
                  <div class="card">
                  <div class="card-body">
                    <h5 style ="text-transform: capitalize;" class="card-title"><?php echo $a['mapel']?></h5>
